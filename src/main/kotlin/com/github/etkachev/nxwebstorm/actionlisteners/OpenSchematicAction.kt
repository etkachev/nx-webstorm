...
class SchematicActionListener(private val list: JBList<String>, private val schematics: Map<String, String>,
                              private val panel: SchematicsListDialog) : ListSelectionListener {
