...
class SchematicsListDialog(val project: Project?, private val schematics: Map<String, String>): DialogWrapper(project) {
    init {
        super.init()
    }
    override fun createCenterPanel(): JComponent? {
        ...
        list.addListSelectionListener(SchematicActionListener(proj, list, schematics, this))
        return panel {
            row {
                list()
            }
